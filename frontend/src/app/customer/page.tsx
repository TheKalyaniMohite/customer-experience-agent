      ...
      <header className="flex-shrink-0 border-b border-[var(--border)] bg-[var(--sidebar-bg)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-[var(--foreground)]">Customer Dashboard</h1>
          </div>
          <Link
            href="/"
        ...
        <div className="w-full max-w-md">
          <div className="card p-8 sm:p-12 text-center">
            ...
            <p className="text-[var(--muted)] mb-8">
              Access your support tickets and chat with our team. Continue as guest to get started.
            </p>
            <div className="flex flex-col gap-3">
              <Link href="/customer/guest" className="btn btn-primary w-full">
                Continue as Guest
              </Link>
            </div>
          </div>
